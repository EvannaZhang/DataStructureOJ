...
//	        										order[4] = n;
//	        										int now = 0;
//	    	    	        	        			now = now + tree[must[order[0]]].distance[5];
//	    	    	        	        				now = now + tree[must[order[1]]].distance[order[0]];
//	    	    	        	        				now = now + tree[must[order[2]]].distance[order[1]];
//	    	    	        	        				now = now + tree[must[order[3]]].distance[order[2]];
//	    	    	        	        				now = now + tree[must[order[4]]].distance[order[3]];
//	    	    	        		        			now = now + tree[must[order[4]]].distance[6];
//	    	    	        		        			if(now<answer)
//	    	    	        			        			answer = now;
//	    	    	        	        			
//	        						
...
//	    	        	        				now = now + tree[must[order[2]]].distance[order[1]];
//	    	        	        				now = now + tree[must[order[3]]].distance[order[2]];
//	    	        		        			now = now + tree[must[order[3]]].distance[6];
//	    	        		        			if(now<answer)
//	    	        			        			answer = now;
//	    	        	        			}
//	        				}
...
//	        	        				now = now + tree[must[order[1]]].distance[order[0]];
//	        	        				now = now + tree[must[order[2]]].distance[order[1]];
//	        		        			now = now + tree[must[order[2]]].distance[6];
//	        		        			if(now<answer)
//	        			        			answer = now;
//	        	        			}
//	        			}
...
//	        				now = now + tree[must[order[0]]].distance[5];
//	        				now = now + tree[must[order[1]]].distance[order[0]];
//		        			now = now + tree[must[order[1]]].distance[6];
//		        			if(now<answer)
//			        			answer = now;
//	        			}
//	        		}
...
//	        			int now = 0; 
//	        			now = now + tree[must[order[0]]].distance[5];
//	        			now = now + tree[must[order[0]]].distance[6];
//	        		if(now<answer)
//	        			answer = now;
//	        		}
//	        	}
